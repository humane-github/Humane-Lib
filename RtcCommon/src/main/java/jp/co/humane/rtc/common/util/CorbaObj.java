...
public class CorbaObj {
    ...
    /**
     * 無害な値で初期化されたTimedStringを生成する。
     * @return TimedString.
     */
    public static TimedString newTimedString() {
        return new TimedString(new Time(0, 0), "");
    }

    /**
     * 指定の値で初期化されたTimedStringを生成する。
     * @return TimedString.
     */
    public static TimedString newTimedString(String val) {
        return new TimedString(new Time(0, 0), val);
    }
